...
//         covidLogo: document.querySelector("#scroll-section-0 .covid-logo"),
...
//         covidLogo_width_in: [1000, 200, { start: 0.1, end: 0.4 }],
//         covidLogo_translateX_in: [-12, -18, { start: 0.2, end: 0.4 }],
//         covidLogo_width_out: [200, 50, { start: 0.4, end: 0.8 }],
//         covidLogo_translateX_out: [-18, -50, { start: 0.4, end: 0.8 }],
//         covidLogo_opacity_out: [1, 0, { start: 0.8, end: 0.9 }],
//         path_dashoffset_in: [1401, 0, { start: 0.2, end: 0.4 }],
//         path_dashoffset_out: [0, -1401, { start: 0.5, end: 0.7 }],
//       },
//     },
//   ];
...
//         if (scrollRatio <= 0.4) {
//           objs.covidLogo.style.width = `${calcValues(
//             values.covidLogo_width_in,
//             currentYOffset
//           )}vw`;
//           objs.covidLogo.style.transform = `translate(${calcValues(
//             values.covidLogo_translateX_in,
//             currentYOffset
//           )}%, -50%)`;
//         } else {
//           objs.covidLogo.style.width = `${calcValues(
//             values.covidLogo_width_out,
//             currentYOffset
//           )}vw`;
//           objs.covidLogo.style.transform = `translate(${calcValues(
//             values.covidLogo_translateX_out,
//             currentYOffset
//           )}%, -50%)`;
//         }
...
//         objs.covidLogo.style.opacity = calcValues(
//           values.covidLogo_opacity_out,
//           currentYOffset
//         );
...
//     if (
//       yOffset <
//       prevScrollHeight + sceneInfo[currentScene].scrollHeight * 0.8
//     ) {
